<template>
  <div class="max-w-4xl mx-auto">
    <div class="contact-header border-4 border-black bg-brutal-orange p-8 mb-12 brutal-shadow transform -rotate-1 opacity-0">
      ...
      <p class="text-2xl font-bold mt-4 bg-black text-white inline-block px-4 py-2">
    ...
    <form @submit.prevent="submitForm" class="contact-form bg-white border-4 border-black p-8 md:p-12 brutal-shadow space-y-8 opacity-0 translate-y-12">
      ...
      <!-- Email Input -->
      <div class="flex flex-col gap-2">
        <label for="email" class="text-2xl font-black uppercase">WHERE TO SEND INVOICES?</label>
        <input 
          id="email" 
          type="email" 
      ...
      <!-- Message Input -->
      <div class="flex flex-col gap-2">
        <label for="message" class="text-2xl font-black uppercase">WHAT DO YOU WANT?</label>
        <textarea 
          id="message" 
          rows="5"
